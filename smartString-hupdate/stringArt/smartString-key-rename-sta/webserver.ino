void initWebServer(){
  ...
  server.on("/standalone",[](){server.send(200,"text/plain","Standalone Mode");wToggle=1;wifiConfigure();});
...
void handleFileUpload(){
  ...
  if(upload.status == UPLOAD_FILE_START){
    String fntmp = upload.filename;
    //  rename Filename
    String filename = fntmp.substring(0,fntmp.indexOf(".")) + ".sta";
